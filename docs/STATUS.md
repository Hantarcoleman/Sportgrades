...
### ניהול קבוצות
- ✅ העלאת Excel — אלפון (ת.ז + שם) וגיליון ציונים משו"ב, שניהם מתקבלים
- ✅ ייצוא משו"ב — שמירת תבנית בזיכרון מקומי (לא צריך להעלות שוב)
- ✅ ייצוא לאלפון — עמודת "ציון מספרי" מתווספת אוטומטית אם אין
...
- ✅ הדגשת קבוצה פעילה בסיידבר

### אימות
- ✅ כניסה עם אימייל + סיסמה (Supabase Auth)
- ✅ כניסה עם Google (OAuth) — redirectTo נכון ל-GitHub Pages + localhost
- ✅ `ensureProfile()` — יצירת פרופיל אוטומטית למשתמש Google חדש + בדיקת גבול 50 משתמשים
